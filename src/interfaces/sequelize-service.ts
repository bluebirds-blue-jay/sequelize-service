...
export interface ISequelizeService<A, CP> {
  ...
  find(filters: TFilters<A>, options?: TFindOptions<A, CP>): Promise<Collection<A>>;
  warn(condition: boolean, message: string, data?: object): void;
  findOne(filters: TFilters<A>, options?: TFindOneOptions<A, CP>): Promise<A>;
  findByPrimaryKey(pk: string | number, options?: TFindByPrimaryKeyOptions<A, CP>): Promise<A>;
  findByPrimaryKeys(pks: string[] | number[], options?: TFindByPrimaryKeyOptions<A, CP>): Promise<Collection<A>>;
  ...
  replaceOne(filters: TFilters<A>, values: A, options?: TReplaceOneOptions<A, CP>): Promise<A>;
}